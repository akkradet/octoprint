...
sudo wget -O multi_octo.sh https://raw.githubusercontent.com/akkradet/octoprint/master/multi_octo24.sh && sudo chmod 755 multi_octo24.sh && sudo ./multi_octo24.sh && echo
```
